function [bisc,er,x_r]= metodo_falsa_posicion(x1,x2,m,g,t,v,error_minimo)
...
z = factor_c(x1,m,g,t,v)*factor_c(x2,m,g,t,v); %lo calculo una vez para la primer ejecución del while
 ...
 while (z < 0 && er > error_minimo )%do
   ...
   %if (z < 0) 
   xr = x2 - (factor_c(x2,m,g,t,v) * (x1 - x2)) / (factor_c(x1,m,g,t,v) - factor_c(x2,m,g,t,v));
  ...
  pkg load tablicious  %solo octave
